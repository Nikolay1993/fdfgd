...
class Mage_Core_Model_Config_Options extends Varien_Object
{
    ...
    {
        //return $this->getDataSetDefault('code_dir', $this->getAppDir().My.'code');
        return $this->_data['code_dir'];
    }

    public function getDesignDir()
    {
        //return $this->getDataSetDefault('design_dir', $this->getAppDir().My.'design');
        return $this->_data['design_dir'];
    }

    public function getEtcDir()
    {
        //return $this->getDataSetDefault('etc_dir', $this->getAppDir().My.'etc');
        return $this->_data['etc_dir'];
    }

    public function getLibDir()
    {
        //return $this->getDataSetDefault('lib_dir', $this->getBaseDir().My.'lib');
        return $this->_data['lib_dir'];
    }

    public function getLocaleDir()
    {
        //return $this->getDataSetDefault('locale_dir', $this->getAppDir().My.'locale');
        return $this->_data['locale_dir'];
    }

    public function getMediaDir()
    {
        //return $this->getDataSetDefault('media_dir', $this->getBaseDir().My.'media');
        return $this->_data['media_dir'];
    }

    public function getSkinDir()
    {
        //return $this->getDataSetDefault('skin_dir', $this->getBaseDir().My.'skin');
    ...
    {
        //$dir = $this->getDataSetDefault('var_dir', $this->getBaseDir().My.'var');
    ...
    {
        //$dir = $this->getDataSetDefault('tmp_dir', $this->getVarDir().My.'tmp');
    ...
    {
        //$dir = $this->getDataSetDefault('cache_dir', $this->getVarDir().My.'cache');
    ...
    {
        //$dir = $this->getDataSetDefault('log_dir', $this->getVarDir().My.'log');
    ...
    {
        //$dir = $this->getDataSetDefault('session_dir', $this->getVarDir().My.'session');
    ...
    {
        //$dir = $this->getDataSetDefault('upload_dir', $this->getMediaDir().My.'upload');
    ...
    {
        //$dir = $this->getDataSetDefault('export_dir', $this->getVarDir().My.'export');
